    ...
    <div class="container mx-auto px-4 w-full md:w-3/4 lg:w-3/5 xl:w-1/2 mt-20">
        ...
        <div v-else>
            <div class="text-lg text-gray-600">By 
                 <router-link :to="{name: 'author', params: {id: post.author.id}}" class="underline hover:text-indigo-800" >
                    {{ post.author.name }}
                </router-link>
                 in 
            ...
            <div class="mb-24 flex">
                <div class="mr-6">
                    <img :src="'/storage/faces/'+ post.author.avatar" alt="Autho avatar" class="w-16 h-16 rounded-full">
                </div>
